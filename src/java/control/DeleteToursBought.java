 ...
 * @author Admin
 */
@WebServlet(name = "DeleteToursBought", urlPatterns = {"/deletetours"})
public class DeleteToursBought extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(carttours.containsKey(toursId)){
                carttours.remove(toursId);
            }
            session.setAttribute("carttours", carttours);
            response.sendRedirect("carttours");
        }
    }
