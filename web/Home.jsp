<%-- 
    Document   : Home
    Created on : Feb 9, 2022, 9:11:37 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Du lịch Royal Toàn Châm</title>
    ...
    <body>
                ...
                <div class="header-chat-form hide-on-mobile">
                    ...
                    <div class="chat-form-group">
                        ...
                        <div class="chat-form__phone chat-form-animation">
                            <a href="tel:1-800-894-5712" class="chat-form__phone-link">Hotline: 0962043769</a>
                            <a href="tel:1-800-764-042" class="chat-form__phone-link">Or: 0976120574</a>
                        ...
                        <form action="" class="chat-form__form chat-form-animation">
                            ...
                            <div class="form-input-group">
                                ...
                                <label class="form-input__agree-text" for="form-input-agreement">Đăng ký để nhận cảm hứng du lịch, ưu đãi độc quyền và tin tức mới nhất của chúng tôi.</label>
                            </div>
                            ...
                            <div class="grid wide">
                                <div class="row">
                                    <div class="col l-12 m-12 s-12 slow-appear">
                                        <h1 class="content-heading__brand">Du lịch Royal Toàn Châm</h1>
                                    </div>
                                    <div class="col l-12 m-12 s-12 slow-appear">
                                        <h3 class="content-heading__slogan">Du lịch World</h3>
                                    </div>
                                </div>
                                    ...
                                    <div class="col l-12 m-12 s-12">
                                        <div class="content-heading__nav slow-appear">
                                            <a href="" class="content-heading__link">
                                                <span class="content-heading-link__name">Thông tin về chúng tôi</span>
                                            ...
                                            <a href="" class="content-heading__link">
                                                <span class="content-heading-link__name">Đặt Tours</span>
                                                <span class="content-heading-link__icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="7.325" height="12.173" viewBox="0 0 7.325 12.173" class="">
                                                    <g id="Group_16" data-name="Group 16" transform="translate(9.248 11.643) rotate(180)">
                                                    <path id="Path_13" data-name="Path 13" d="M5.718,0,0,5.718,5.718,11.1" transform="translate(3 0)" fill="none" stroke="#fff" stroke-width="1.5"></path>
                                            ...
                                            <a href="" class="content-heading__link">
                                                <span class="content-heading-link__name">Đặt đồ ăn</span>
                                                <span class="content-heading-link__icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="7.325" height="12.173" viewBox="0 0 7.325 12.173" class="">
                                                    <g id="Group_16" data-name="Group 16" transform="translate(9.248 11.643) rotate(180)">
                                                    <path id="Path_13" data-name="Path 13" d="M5.718,0,0,5.718,5.718,11.1" transform="translate(3 0)" fill="none" stroke="#fff" stroke-width="1.5"></path>
                    ...
                    <div class="col l-6 m-12 s-12">
                        <div class="content-intro__group">
                            ...
                            <p class="content-section__disc content-intro__disc">
                                Một khi bạn đã đi thì chuyến đi không bao giờ kết thúc. Du lịch Royal Toàn Châm sẽ mở ra một thế giới kỳ diệu và tạo ra những ký ức kỳ diệu sẽ ở lại với bạn vượt xa những chuyến đi của bạn.
                                <br>
                                <br>
                                Khác biệt với các dịch vụ du lịch tiêu biểu để hướng đến những trải nghiệm độc đáo, đích thực. Trải nghiệm được thiết kế trong môi trường xung quanh đầy cảm hứng nhất sẽ là của bạn và chỉ của bạn. Hành trình tạo ra những khoảnh khắc đáng nhớ và hành trình đặt riêng của Du lịch Royal Toàn Châm sẽ biến điều này thành hiện thực. Các kỳ quan của Việt Nam đều nằm trong tầm tay của bạn.
                            </p>
                            <a href="" class="link-to">Liên hệ với chúng tôi ngay</a>
                ...
                <div class="row">
                    <div class="col l-6 m-12 s-12">
                        <h3 class="content-section__heading content-exp__heading">
                            Hành trình thiết kế riêng
                        </h3>
                    </div>
                    <div class="col l-6 m-12 s-12">
                        <div class="content-exp__group">
                            <p class="content-section__disc content-exp__disc">
                                Du lịch Royal Toàn Châm lập hành trình cho khách hàng của chúng tôi mà những người khác đơn giản là không thể, cho dù xoay quanh một chủ đề hay một trải nghiệm riêng tư. Đội ngũ tư vấn giàu kinh nghiệm của chúng tôi luôn lắng nghe, thấu hiểu và từ đó tạo ra một hành trình phù hợp cho bạn. Chúng tôi tin rằng du lịch không chỉ làm phong phú thêm nhận thức, hiểu biết và đánh giá cao của bạn về Thế giới mà còn cho phép bạn hỗ trợ các cộng đồng địa phương mà bạn đến thăm. Chúng tôi cho phép bạn khám phá với mục đích, sự nhiệt tình và sự đánh giá cao mới tìm thấy đối với nghệ thuật du lịch. Trải nghiệm các nền văn hóa đa dạng; đắm mình trong những trải nghiệm đích thực; lấy lại khoảnh khắc và kết nối lại với một thái độ vui vẻ đối với cuộc sống.
                            </p>
                            <a href="" class="link-to">Chia sẻ kinh nghiệm</a>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <a href="" class="content-exp-slide__item-link">
                                                ...
                                                <span class="content-exp-slide__item-infor">
                                                    <h5 class="content-exp-slide__text">
                                                        Sinh vật kỳ lạ ở Madagascar và Nam Phi
                                                    </h5>
                                                </span>
                ...
                <div class="row s-gutters">
                    <div class="col l-6 m-6 s-6">
                        <a class="content-destination__card">
                            <img src="./img/content/Cliffs-of-Moher.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-6 m-6 s-6">
                        <a class="content-destination__card">
                            <img src="./img/content/connor-mollison.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-4 m-6 s-6">
                        <a href="" class="content-destination__card">
                            <img src="./img/content/jack-ward.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-4 m-6 s-6">
                        <a href="" class="content-destination__card">
                            <img src="./img/content/rsz_loisaba_tented_camp.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-4 m-6 s-6">
                        <a href="" class="content-destination__card">
                            <img src="./img/content/ryk-porras.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-3 m-6 s-6">
                        <a href="" class="content-destination__card">
                            <img src="./img/content/sorasak-_UIN-pFfJ7c-unsplash-3.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-3 m-6 s-6">
                        <a href="" class="content-destination__card">
                            <img src="./img/content/lieselot-dalle.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-3 m-6 s-6">
                        <a href="" class="content-destination__card">
                            <img src="./img/content/hans-jurgen-mager.jpg" alt="" class="content-destination__img">
                    ...
                    <div class="col l-3 m-6 s-6">
                        <a href="" class="content-destination__card">
                            <img src="./img/content/ian-badenhorst.jpg" alt="" class="content-destination__img">
                ...
                <div class="row no-gutters">
                    <div class="col l-6 m-0 s-0 relative">
                        <div class="content-about__left-img hide-on-mobile-tablet">
                            <img src="./img/content/about_square_bigger@2x.jpg" alt="" class="content-about__main-img">
                        </div>
                        <div class="content-about__right-img hide-on-mobile-tablet">
                            <img src="./img/content/about_square_smaller@2x.jpg" alt="" class="content-about__secondary-img">
                        </div>
                    </div>
                    <div class="col l-6 m-12 s-12">
                        ...
                        <div class="content-about__right">
                            <p class="content-section__disc content-about__disc">
                                Đội ngũ các nhà thiết kế du lịch giàu kinh nghiệm của chúng tôi sẽ hướng dẫn bạn từ đầu đến cuối khi bạn bắt đầu hành trình tạo sự khác biệt, tận hưởng những trải nghiệm văn hóa thực sự độc đáo và đích thực. Chúng tôi có thể thực hiện ước mơ của bạn trong bucket-list.                            </p>
            ...
            <div class="content-news__container">
                <div class="grid wide">
                    <div class="content-news__heading">
                        <h3 class="content-section__heading">Nổi bật</h3>
                        <a href="" class="link-to hide-on-mobile">Ưa chuộng</a>
                    </div>
                    <div class="row sm-gutter">
                        <div class="col l-4 m-6 s-12">  
                            <a href="" class="content-news__item">
                                <div class="content-news__img-box">
                                    <img src="./img/content/8-min-2000x1333.jpg" alt="" class="content-news__img">
                                </div>
                                <div class="content-news__info">
                                    ...
                                    <div class="content-news__cat">Điểm đến nổi bật</div>
                        ...
                        <div class="col l-4 m-6 s-12">
                            <a href="" class="content-news__item">
                                <div class="content-news__img-box">
                                    <img src="./img/content/7.jpg" alt="" class="content-news__img">
                                </div>
                                <div class="content-news__info">
                                    <span class="content-news__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" class="">
                        ...
                        <div class="col l-4 m-6 s-12">
                            <a href="" class="content-news__item">
                                <div class="content-news__img-box">
                                    <img src="./img/content/6-min-2000x1333.jpg" alt="" class="content-news__img">
                                </div>
                                <div class="content-news__info">
                                    <span class="content-news__icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" class="">
                        ...
                        <div class="content-says-container">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="content-says-slide__item swiper-slide">
                                            <div class="content-section__disc content-says-slide__item-text">
                                                ...
                                                <p class="content-says-slide__item-disc">
                                                    Đó là một chuyến đi tuyệt vời, tất cả chúng tôi đều yêu Scotland, và Fiona! Cảm ơn bạn vì tất cả mọi thứ, nó đã được lên kế hoạch hoàn hảo và đúng thời gian !!                                                </p>
                                                <span class="content-says-slide__item-quote">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="89" viewBox="0 0 35 89" class="">
                                                    <text id="_" data-name="“" transform="translate(35 20) rotate(180)" fill="#613842" font-size="89" font-family="Helvetica-Light, Helvetica" font-weight="300"><tspan x="0" y="0">“</tspan></text>
                                                    </svg>
                            ...
                            <div class="content-says__control">
                                <div class="btn-primary content-says-slide__btn swiper-button-prev-says">
                                    <i class="btn-primary__icon fas fa-chevron-left"></i>
                                </div>
                                <div class="btn-primary content-says-slide__btn swiper-button-next-says">
                                    <i class="btn-primary__icon fas fa-chevron-right"></i>
                                </div>
                            </div>
                        </div>
                        <img src="./img/content/home_bottom_image.jpg" alt="" class="content-says__background-img hide-on-mobile">
                    </div>
                </div>
            </div>
        </section>
        <section class="content-signup">
            <div class="content-signup__content">
                Nhận thông tin mới nhất từ Du lịch Royal Toàn Châm:&nbsp;
                <span class="content-signup__content-underline">Đăng kí tờ báo của chúng tôi</span>
            </div>
        </section>
    </div>
    <footer class="footer">
                                ...
                                <div class="footer-top-slide__slider swiper-footer">
                                    <div class="swiper-wrapper">
                                        <div class="footer-top-slide__slide-item swiper-slide">
                                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/brand/logo/licenced_footer.svg" alt="" class="footer-top-slide__img">
                                        </div>
                                        <div class="footer-top-slide__slide-item swiper-slide">
                                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/members/select_logo.svg" alt="" class="footer-top-slide__img">
                                        </div>
                                        <div class="footer-top-slide__slide-item swiper-slide">
                                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/members/itaa_logo.svg" alt="" class="footer-top-slide__img">
                                        </div>
                                        <div class="footer-top-slide__slide-item swiper-slide">
                                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/members/a-list.svg" alt="" class="footer-top-slide__img">
                                        </div>
                                        <div class="footer-top-slide__slide-item swiper-slide">
                                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/members/green_award_logo.svg" alt="" class="footer-top-slide__img">
                                        </div>
                                        <div class="footer-top-slide__slide-item swiper-slide">
                                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/members/Founding-member-badge-01-1-1.png" alt="" class="footer-top-slide__img">
                                        </div>
                                        <div class="footer-top-slide__slide-item swiper-slide">
                                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/members/about_logo_list_5_2x.svg" alt="" class="footer-top-slide__img">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col l-9 ml-9 m-0 s-0">
                        <div class="footer-nav">
                            <div class="footer-nav-item">
                                <h4 class="footer-nav-item__heading">TRẢI NGHIỆM CÓ LỢI</h4>
                                <ul class="footer-nav-item-list">
                                    <li class="footer-nav-item-list__item">
                                        <a href="" class="footer-nav-item-list__item-link">Cuộc phiêu lưu</a>
                                    </li>
                                    <li class="footer-nav-item-list__item">
                                        <a href="" class="footer-nav-item-list__item-link">Lễ kỷ niệm</a>
                                    </li>
                                    <li class="footer-nav-item-list__item">
                                        <a href="" class="footer-nav-item-list__item-link">Âmr thực</a>
                                    </li>
                                    <li class="footer-nav-item-list__item">
                                        <a href="" class="footer-nav-item-list__item-link">Gia đình</a>
                                    </li>
                                    <li class="footer-nav-item-list__item">
                                        <a href="" class="footer-nav-item-list__item-link">Ultraluxe</a>
                                    </li>
                                    <li class="footer-nav-item-list__item">
                                        <a href="" class="footer-nav-item-list__item-link">Hành trình</a>
                                    </li>
                                    <li class="footer-nav-item-list__item">
                                        <a href="" class="footer-nav-item-list__item-link">Chuyên môn</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="footer-nav-item">
                                <h4 class="footer-nav-item__heading">Các điểm đến</h4>
                                <ul class="footer-nav-item-list">
                                    <li class="footer-nav-item-list__item">
                        ...
                        <div class="footer-brand-info">
                            ...
                            <div class="footer-brand-info__social">
                                <a href="" class="footer-brand-info__social-link">
                                    <i class="footer-brand-info__social-icon fab fa-facebook-f"></i>
                                </a>
                                <a href="" class="footer-brand-info__social-link">
                                    <i class="footer-brand-info__social-icon fab fab fa-twitter "></i>
                                </a>
                                <a href="" class="footer-brand-info__social-link">
                                    <i class="footer-brand-info__social-icon fab fa-instagram"></i>
                                </a>
                                <a href="" class="footer-brand-info__social-link">
                                    <i class="footer-brand-info__social-icon fab fa-youtube"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="footer-bottom-container">
                        <div class="footer-bottom-licence">
                            <img src="https://chuong3x.github.io/natalieandcharlie/asset/img/brand/logo/licenced_footer.svg" alt="" class="footer-bottom-licence__img">
                        ...
                        <ul class="footer-bottom-legal">
                            ...
                            <li class="footer-bottom-legal__item">
                                <p class="footer-bottom-legal__item-link">Natalie & Charlie ©2021</p>
                            </li>
                            <li class="footer-bottom-legal__item">
                                <p class="footer-bottom-legal__item-link">Site by</p>
                                <a href="" class="footer-bottom-legal__item-link">Charlie</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<script src="js/swiper-bundle.esm.browser.min.js" type="text/javascript"></script>
...
<script class="iti-load-utils" src="lib/utils.js" type="text/javascript"></script>
</body>
</html>
